...
a = AStarSearcher(Forward_STRIPS(problem1)).search()  #A*
#b = SearcherMPP(Forward_STRIPS(problem1)).search()  #A* with MPP
#c = DF_branch_and_bound(Forward_STRIPS(problem1),10).search() #B&B
